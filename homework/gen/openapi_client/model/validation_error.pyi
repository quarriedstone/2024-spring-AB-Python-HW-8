...
class ValidationError(
    ...
    class MetaOapg:
        ...
        class properties:
            loc = schemas.AnyTypeSchema
            msg = schemas.AnyTypeSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        msg: typing.Union[MetaOapg.properties.msg, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        loc: typing.Union[MetaOapg.properties.loc, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
