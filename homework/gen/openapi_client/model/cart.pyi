...
class Cart(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            products = schemas.AnyTypeSchema
            __annotations__ = {
                "id": id,
                "products": products,
            }
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "products", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "products", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        products: typing.Union[MetaOapg.properties.products, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Cart':
        return super().__new__(
